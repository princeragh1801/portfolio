              ...
              <CardContent className="flex-grow flex flex-col justify-between">
                <div className="space-y-4">
                  ...
                  <div className="flex gap-4">
                    <Button variant="outline" size="sm" asChild className="border-primary group text-primary hover:bg-primary/10">
                ...
                <Button variant="outline" asChild className="group w-full mt-4 border-primary text-primary hover:bg-primary/10">
